...
Meteor.methods({
	blockUpdate: function(blockId, updates) {
		...
		if(updates.rate != undefined || updates.hours != undefined || updates.percent != undefined || updates.checked != undefined || updates.isParent != undefined) {
			...
			Blocks.find({estimationId: currentBlock.estimationId, nonDevelopment: true}).forEach(function(element) {
				if(element.isParent != true){
					if(element.checked == true){
						nonDevelopmentTotalHours += (parseInt(element.percent) / 100 * developmentTotalHours);
